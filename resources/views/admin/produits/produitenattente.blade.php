            ...
            <form method="POST" action="{{ route('produits.store') }}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="checkbox" data-toggle="switchbutton" checked data-onstyle="primary" name="statut" data-offstyle="secondary">
                    </div>
                    <div class="mb-3">
        ...
        <tbody>
            ...
            @else
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('produits.updateStatus', $product->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('PATCH')
                            <input type="hidden" name="toback" value="1">
                            <input type="checkbox" data-toggle="switchbutton" name="statut" {{ $product->statut ? 'checked' : '' }} data-onstyle="primary" data-offstyle="secondary" onchange="this.form.submit()">
                        </form>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <a href="{{ route('produits.edit', $product->id) }}" class="btn btn-warning btn-sm">Editer</a>
