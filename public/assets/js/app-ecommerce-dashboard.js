...
(function () {
      ...
      Swal.fire({
        ...
        if (result.value) {
          Swal.fire({
            icon: 'success',
            title: 'Supprimé!',
            text: 'Vous avez supprimé ce produit',
            customClass: {
  ...
  const totalRevenueChartElProduct = document.querySelector('#totalRevenueChartProduct'),
  totalRevenueChartOptionsProduct = {
    series: [
      {
        name: 'Entrée',
    ...
    xaxis: {
      categories: ['Jan', 'Fev', 'Mar', 'Avr', 'Mai', 'Juin', 'Jui', 'Aoû', 'Sep'],
      labels: {
        style: {
          fontSize: '13px',
          colors: labelColor,
...
if (typeof totalRevenueChartElProduct !== undefined && totalRevenueChartElProduct !== null) {
  const totalRevenueChartProduct = new ApexCharts(totalRevenueChartElProduct, totalRevenueChartOptionsProduct);
  totalRevenueChartProduct.render();
}
